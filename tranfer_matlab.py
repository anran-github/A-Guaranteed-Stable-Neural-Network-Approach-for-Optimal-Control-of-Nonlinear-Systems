...
model.load_state_dict(torch.load('weights_DRONE/y/0.01/new_model_theta0.01_epoch3350_5.551_u0.243.pth'))
...
torch.onnx.export(model,               # model being run
                  ...
                  "Drone_Experiments/weights_NOM/NN_y_2.onnx",   # where to save the model (can be a file or file-like object)
