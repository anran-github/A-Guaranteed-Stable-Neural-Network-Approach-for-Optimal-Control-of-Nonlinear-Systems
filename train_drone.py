...
parser.add_argument('--dataset',type=str,default='Drone_NOM_Dataset_0.01_2.txt', help='corresponding theta dataset')
parser.add_argument('--lr',type=float, default=0.001, help='learning rate')
parser.add_argument('--pre_trained', type=str, default='weights_DRONE/z/0.01/new_model_theta0.01_epoch3300_0.000_u0.003.pth',help='input your pretrained weight path if you want')
...
theta = float(args.dataset.split('_')[-2])
save_path = f'weights_DRONE/z/{theta}'
...
input_data = torch.stack([data[:,0],data[:,1], data[:,-1]],dim=1)
